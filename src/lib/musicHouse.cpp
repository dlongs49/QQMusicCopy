...
MusicHouese::MusicHouese(QWidget *parent) : QWidget(parent) {
...
void MusicHouese::RecommHeartbeat() {
    recomOutBox = new QWidget(widget);
    recomOutBox->setFixedWidth(this->width()- 20);
    recomOutLayout = new QVBoxLayout;
    recomOutLayout->setSpacing(0);
...
void MusicHouese::RecommProgram() {
    recomOutBox = new QWidget(widget);
    recomOutBox->setFixedWidth(this->width()- 20);
    recomOutLayout = new QVBoxLayout;
    recomOutLayout->setSpacing(0);
...
QPixmap *MusicHouese::getImage(QString url) {
...
// 左右箭头部件
QLabel *MusicHouese::arrowBox(int i, QString type) {
    if (type == "left") {
...
// 左右箭头切换隐藏
void MusicHouese::showArrow(QObject *o, QEvent *e, int i) {
...
// 轮播图切换
void MusicHouese::toggleItem(QWidget *itemBox, QString objName, QEvent *e) {
...
bool MusicHouese::eventFilter(QObject *o, QEvent *e) {
